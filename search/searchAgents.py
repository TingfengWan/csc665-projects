        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                if next_node in self.corners:
                    if next_node not in Corners:
                        Corners.append( next_node )
                successor = ((next_node, Corners), action, 1)
...
def cornersHeuristic(state, problem):
    ...
    while(len(un_Visited_Corner)!=0):
        distance, corner = min( [(util.manhattanDistance(current_position ,corner),corner) for corner in un_Visited_Corner] )
        ...
        while frontier:
            ...
            if state not in Visited:
                ...
                for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
                    ...
                    if next_state not in walls.asList():
